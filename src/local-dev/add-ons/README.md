...
cp activemq-log-plugins/target/activemq-log-plugin.jar \
   <path-to-this-repo>/applications/swim-ed254-provider/src/local-dev/add-ons/activemq-log-plugin.jar
...
cp keycloak-swim-role-spi/target/keycloak-swim-role-spi-1.0.0-SNAPSHOT.jar \
   <path-to-this-repo>/applications/swim-ed254-provider/src/local-dev/add-ons/keycloak-swim-role-spi.jar
```
